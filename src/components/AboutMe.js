      ...
      <div className="aboutme-container">
        ...
        <div className="description">
          ...
          <div className="text">
            ...
            and web development, as well as the C# .Net framework. I am looking
            to gain more valuable experience in an IT environment and expand my
            competence. I am ready for challenges and eager to learn and acquire
            new skills.
            <br />
            <br /> I graduated from the University of Westminster in United
            Kingdom with a degree in Software Engineering with a (Second Class
            ...
            <a
              href="https://www.facebook.com/nipunadkphotography/photos"
              rel="noreferrer"
              target="_blank"
              title="Click to view my collections"
            >
